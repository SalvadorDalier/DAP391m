...
for i, col in enumerate(cols):
    plt.subplot(1, 3, i+1)
    sns.boxplot(x='Is_Redeemer', y=col, data=df_test, hue='Is_Redeemer', palette='Set2', legend=False)
...
sns.barplot(x=cb_table.index, y=cb_table['Lợi nhuận ròng'], hue=cb_table.index, palette='RdYlGn', legend=False)
